...
void initMultican(void)
{
    ...
    g_multican.canNodeConfig.rxPin     = &IfxMultican_RXD0B_P20_7_IN;                                          // RX�� ����
    g_multican.canNodeConfig.rxPinMode = IfxPort_InputMode_pullUp;
    g_multican.canNodeConfig.txPin     = &IfxMultican_TXD0_P20_8_OUT;                                          // TX�� ����

    IfxMultican_Can_Node_init(&g_multican.canSrcNode, &g_multican.canNodeConfig);                              // TX configuration ����
    ...
    g_multican.canNodeConfig.baudrate = 500000UL;                                                              // CAN �ӵ� ���� 500kbps
    ...
    IfxMultican_Can_Node_init(&g_multican.canDstNode, &g_multican.canNodeConfig);                              // RX configuration ����
